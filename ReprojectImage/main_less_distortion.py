...
CalibAtribs = np.load("../camera_calibration_out/calculated_cams_matrix_less_distortion.npz")
...
for dataset in datasets:
    for captureFolder in os.listdir(baseReadPath+dataset):
        ...
        os.makedirs(baseReadPath+dataset+"/"+"LessDOut"+"/", exist_ok=True)

        open3d.write_point_cloud(baseReadPath+dataset+"/"+"LessDOut"+"/"+"capturedPointCloud_"+captureFolder + ".ply", pcd)

        with open(baseReadPath+dataset+"/"+"LessDOut"+"/"+"capturedPointCloud_"+captureFolder + ".bin", "wb") as fp:
        ...
        open3d.write_point_cloud(baseReadPath+dataset+"/"+"LessDOut"+"/"+"downsampled_capturedPointCloud_"+captureFolder + ".ply", downpcd)

        with open(baseReadPath+dataset+"/"+"LessDOut"+"/"+"downsampled_capturedPointCloud_"+captureFolder + ".bin", "wb") as fp:
        ...
        open3d.write_point_cloud(baseReadPath + dataset + "/" + "LessDOut"+"/"+"filtered__capturedPointCloud__" + captureFolder + ".ply", pcd)

        with open(baseReadPath + dataset + "/" + "LessDOut"+"/"+"filtered__capturedPointCloud__" + captureFolder + ".bin", "wb") as fp:
